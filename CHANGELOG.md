...
- Use of the quay.io container registry for minio ([Merge Request](https://codebase.helmholtz.cloud/hub-terra/sms/orchestration/-/merge_requests/749))
...
- Removed the unused schema version and identifier type fields from the device and platform schema ([Merge Request](https://codebase.helmholtz.cloud/hub-terra/sms/orchestration/-/merge_requests/716))
- Cache userinfo only as long as the token is valid ([Merge Request](https://codebase.helmholtz.cloud/hub-terra/sms/orchestration/-/merge_requests/715))
...
- The directory of the MC image Dockerfile has been updated for the FZJ prod instance. ([Merge Request](https://codebase.helmholtz.cloud/hub-terra/sms/orchestration/-/merge_requests/698))
...
- Configured FZJ S3 bucket for the sms-attachments ([Merge Request](https://codebase.helmholtz.cloud/hub-terra/sms/orchestration/-/merge_requests/668))
