...
class TestDeviceSoftwareUpdateActionAttachment(BaseTestCase):
    ...
    def test_post_device_software_update_action_attachment(self):
        ...
        self.expect(call_args[0]).to_equal(
            "sms/post-device-software-update-action-attachment"
        )
        ...
        ).to_equal(str(device_software_update_action.id))
    ...
    def test_update_device_software_update_action_attachment(self):
        ...
        self.expect(call_args[0]).to_equal(
            "sms/patch-device-software-update-action-attachment"
        )
        notification_data = json.loads(call_args[1])["data"]
        self.expect(notification_data["type"]).to_equal(
            "device_software_update_action_attachment"
        ...
        self.expect(
            notification_data["relationships"]["action"]["data"]["id"]
        ).to_equal(str(device_software_update_action_attachment.action_id))
    ...
    def test_delete_device_software_update_action_attachment(self):
        ...
        self.expect(call_args[0]).to_equal(
            "sms/delete-device-software-update-action-attachment"
        )
        self.expect(json.loads).of(call_args[1]).to_equal(
            {
                "data": {
                    "type": "device_software_update_action_attachment",
                    "id": str(device_software_update_action_attachment.id),
                }
            }
        )
