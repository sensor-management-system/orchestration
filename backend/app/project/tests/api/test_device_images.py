...
def create_group1():
    """Create a permission group to use it in the tests."""
...
@fixtures.register("membership_of_user1_in_group1")
@fixtures.use(["group1", "user1"])
def create_membership_of_user1_in_group1(group1, user1):
    """Create a membership of user1 in the group1."""
    result = PermissionGroupMembership(
