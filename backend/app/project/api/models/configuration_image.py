...
"""Class for a configuration image."""
...
class ConfigurationImage(db.Model, AuditMixin):
    """Configuration image class."""
    ...
    configuration = db.relationship(
        ...
        backref=db.backref(
            "configuration_images", cascade="save-update, merge, delete, delete-orphan"
        ),
    )
    ...
    attachment = db.relationship(
        ...
        backref=db.backref("configuration_images"),
    )
    ...
    def get_parent(self):
        """Get the configuration (as it belongs to it)."""
