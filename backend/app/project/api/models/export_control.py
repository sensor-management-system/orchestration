...
class ExportControl(db.Model, AuditMixin, IndirectSearchableMixin):
    ...
    eu_export_control_classification_number = db.Column(db.String(256), nullable=True)
    us_export_control_classification_number = db.Column(db.String(256), nullable=True)
    us_re_export_control = db.Column(db.Boolean, nullable=True)
