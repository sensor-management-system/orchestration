...
export interface IDeviceBasicData {
  id: string | null
...
export class DeviceBasicData implements IDeviceBasicData {
  ...
  set deviceTypeUri (newDeviceTypeUri: string) {
    this._deviceTypeUri = newDeviceTypeUri
  }
  ...
  set deviceTypeName (newDeviceTypeName: string) {
    this._deviceTypeName = newDeviceTypeName
  }
  ...
  static createEmpty (): DeviceBasicData {
    return new DeviceBasicData()
  }

  static createFromObject (someObject: IDeviceBasicData): DeviceBasicData {
    const newObject = new DeviceBasicData()
