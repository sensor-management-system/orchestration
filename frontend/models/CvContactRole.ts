 ...
 */
export interface ICvContactRole {
  id: string
  name: string
  uri: string
  definition: string
...
export class CvContactRole implements ICvContactRole {
  private _id: string = ''
  ...
  static createWithData (id: string, name: string, uri: string, definition: string): CvContactRole {
    const result = new CvContactRole()
    result.id = id
    result.name = name
    result.uri = uri
  ...
  static createFromObject (someObject: ICvContactRole): CvContactRole {
    const newObject = new CvContactRole()
