...
export class AggregationType implements IAggregationType {
  private _id: string = ''
  ...
  static createFromObject (someObject: IAggregationType): AggregationType {
    const newObject = new AggregationType()
