...
<template>
  <section>
    ...
    <p>Please refer to the <a href="https://www.kit.edu/privacypolicy.php" target="_blank">KIT General Data Privacy Statement</a>.</p>
    <h2 class="mb-1">
...
@Component
export default class KitPrivacyPolicyPage extends Vue {
  created () {
