  ...
  <div>
    ...
    <v-row>
      <v-col cols="12" md="6">
        ...
        <v-tooltip v-if="value.serialNumber && value.hasSystemGeneratedSerialNumber" right>
          <template #activator="{ on, attrs }">
            <v-icon small class="pl-1" color="grey" v-bind="attrs" v-on="on">
              mdi-auto-fix
            </v-icon>
          </template>
          <span>Serial number was generated randomly by the system.</span>
        </v-tooltip>
      </v-col>
      <v-col cols="12" md="6">
