...
import { DevicesState, PageSizesGetter, SetPageSizeAction } from '@/store/devices'

@Component({
  components: { PageSizeSelect },
  computed: {
    ...mapState('devices', ['pageSize']),
    ...mapGetters('devices', ['pageSizes'])
  },
  methods: {
    ...mapActions('devices', ['setPageSize'])
  }
})
export default class DevicePageSizeSelect extends Vue {
