    ...
    <v-row>
      <v-col>
        <v-select
          ...
          :items="platformActionTypeItemsIncludingMounts"
          :item-text="(x) => x.name"
          return-object
          clearable
        >
...
@Component({
  ...
  computed: {
    ...mapGetters('platforms', ['availableYearsOfActions', 'availableContactsOfActions']),
    ...mapGetters('vocabulary', ['platformActionTypeItemsIncludingMounts'])
  }
})
