...
import { PageSizesGetter, PlatformsState, SetPageSizeAction } from '@/store/platforms'

@Component({
  components: { PageSizeSelect },
  computed: {
    ...mapState('platforms', ['pageSize']),
    ...mapGetters('platforms', ['pageSizes'])
  },
  methods: {
    ...mapActions('platforms', ['setPageSize'])
  }
})
export default class PlatformPageSizeSelect extends Vue {
