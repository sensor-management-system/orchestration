...
VALUES (Null, 'Max', 'Mustermann', null, 'max@example.com');
INSERT INTO public."user" (id, subject, contact_id)
VALUES (NULL, 'abbrent', 1);
...
VALUES (null, null, null, 'sdfasdf', 'fasdfas', 'sadfasdfad', 'sadfasdf', 'sadfasdfas', 'sadfasdf', null, null, null,
        null,
...
VALUES (null, 1, 2, 1, null, 'asdfasdfas', 'asdsafd', 'asdfsadf', 'sadfasdf', 'sfafdas', 'asdfasd', 'sdfafasd',
        'fasdfas',
        'sadfasdfa', 1);
...
INSERT INTO public.configuration (created_at, updated_at, id, start_date, end_date, location_type, longitude, latitude,
                                  ...
                                  updated_by_id)
VALUES ('2020-09-08 15:26:22.000000', '2020-09-08 15:26:25.000000', null, '2020-01-01 00:00:00.000000',
        '2021-01-01 00:00:00.000000', 'static', 56.1, 12.3, 42.23, null, null, 1, 1, 1, 1, 1);

INSERT INTO public.configuration_contacts
values (1, 1);

INSERT INTO public.platform (created_at, updated_at, id, description, short_name, long_name, manufacturer_uri,
                             ...
                             updated_by_id)
VALUES (null, null, null, 'sadfasdfas', 'asdfasd', 'afdas', 'asdfasd', 'asfdasf', 'asfasdf', 'afssdfa', 'asfdasdf',
...
INSERT INTO public.platform (created_at, updated_at, id, description, short_name, long_name, manufacturer_uri,
                             ...
                             website, inventory_number, serial_number, persistent_identifier, created_by_id,
                             updated_by_id)
VALUES (null, null, null, 'ewrtewr', 'wertwre', 'ewrtew', 'ewrtwe', 'ewrtwer', 'wert', 'afssdfa', 'asfdasdf', 'asfdsafdas',
        'afdasfas', 'asfdasf', 'asfdsafas', 'afdasdf', 'wertwertewr', 1, 1);


INSERT INTO public.configuration_device (created_at, updated_at, id, offset_x, offset_y, offset_z, calibration_date,
                                         configuration_id, device_id, platform_id, created_by_id, updated_by_id)
VALUES (null, null, null, 1, 2, 3, '2020-09-09 13:14:28.000000', 1, 1, 1, 1, 1);
INSERT INTO public.configuration_platform (created_at, updated_at, id, offset_x, offset_y, offset_z, configuration_id,
                                           parent_platform_id, platform_id, created_by_id, updated_by_id)
VALUES (null, null, null, 3, 4, 5, 1, null, 1, 1, 1);

INSERT INTO public.configuration_platform (created_at, updated_at, id, offset_x, offset_y, offset_z, configuration_id,
                                           parent_platform_id, platform_id, created_by_id, updated_by_id)
VALUES (null, null, null, 6, 6, 6, 1, 1, 2, 1, 1);
