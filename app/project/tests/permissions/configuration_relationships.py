...
class TestDeviceRelationshipPermissions(BaseTestCase):
    ...
    def test_fail_adding_relationship_to_configurations_without_jwt(self):
        ...
        public_config = create_a_test_configuration(public=True, internal=False,)
    ...
    def test_fail_adding_relationship_to_configurations_with_a_group_other_than_user(self):
    ...
    def test_fail_updating_relationship_to_configurations_with_a_group_other_than_user(self):
    ...
    def test_success_updating_relationship_to_configurations_with_a_group_other_than_user(self):
        """Ensure updating a relationship will fail if user not involve in parent permission group."""
        public_config = create_a_test_configuration(
            public=True,
            internal=False,
    ...
    def test_fail_delete_a_relationship_to_configurations_with_a_group_other_than_user(self):
