...
class TestIdlUserGroups(BaseTestCase):
    def test_idl_from_dict(self):
        json_string = '[{"id": 1,"username": "testuser@ufz.de","displayName": "Test User (WKDV)","referencedIri": \
        "/infra/api/v1/accounts/testuser","administratedPermissionsGroups": [2],"memberedPermissionsGroups": [1,3]}]'
