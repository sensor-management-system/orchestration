...
class Test(BaseTestCase):
    ...
    def test_flatten_json(self):
        ...
        expected = {
            "data.type": "device",
            "data.attributes.website": "http://website/device",
            ...
            "data.relationships.contacts.links.self":
                "/rdm/svm-api/v1/devices/22/relationships/contacts",
            "data.relationships.contacts.links.related":
                "/rdm/svm-api/v1/devices/22/contacts",
            "data.relationships.updated_by.links.self":
                "/rdm/svm-api/v1/devices/22/relationships/updatedUser",
            "data.relationships.events.links.self":
                "/rdm/svm-api/v1/devices/22/relationships/events",
            "data.relationships.events.links.related":
                "/rdm/svm-api/v1/events?device_id=22",
            "data.relationships.created_by.links.self":
                "/rdm/svm-api/v1/devices/22/relationships/createdUser",
            "data.id": "22",
            "data.links.self": "/rdm/svm-api/v1/devices/22",
            "links.self": "http://localhost/rdm/svm-api/v1/devices",
            "meta.count": 1,
            "jsonapi.version": "1.0",
        }
        self.assertEqual(
            fj["data.attributes.short_name"], expected["data.attributes.short_name"]
        )
