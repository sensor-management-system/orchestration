...
from ..models import ConfigurationDynamicLocationBeginAction, Configuration, DeviceProperty
    ...
    def query(self, view_kwargs):
        ...
        if x_property_id is not None:
            try:
                ...
                query_ = query_.filter(
                    ConfigurationDynamicLocationBeginAction.x_property_id == x_property_id)
        if y_property_id is not None:
            try:
                ...
                query_ = query_.filter(
                    ConfigurationDynamicLocationBeginAction.y_property_id == y_property_id)
        if z_property_id is not None:
            try:
                ...
                query_ = query_.filter(
                    ConfigurationDynamicLocationBeginAction.z_property_id == z_property_id)
        return query_
