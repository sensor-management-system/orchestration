...
class DevicePropertySchema(MarshmallowSchema):
    ...
    measuring_range_min = fields.Float(as_string=True, allow_none=True, data_key="measureingRangeMin")
    measuring_range_max = fields.Float(as_string=True, allow_none=True, data_key="measureingRangeMax")
    failure_value = fields.Float(as_string=True, allow_none=True, data_key="failureValue")
