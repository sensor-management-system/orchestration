...
def upgrade():
    ...
    with op.batch_alter_table('datastream_link', schema=None) as batch_op:
        batch_op.add_column(sa.Column('datasource_name', sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column('thing_name', sa.String(length=256), nullable=True))
        batch_op.add_column(sa.Column('datastream_name', sa.String(length=256), nullable=True))
