...
def upgrade():
    ...
    op.add_column('device', sa.Column('identifier_type', sa.String(length=256), nullable=True))
    op.add_column('device', sa.Column('schema_version', sa.String(length=256), nullable=True))
    op.alter_column('device', 'manufacturer_name',
               existing_type=sa.VARCHAR(length=256),
               nullable=False)

    op.add_column('platform', sa.Column('identifier_type', sa.String(length=256), nullable=True))
    op.add_column('platform', sa.Column('schema_version', sa.String(length=256), nullable=True))
    op.alter_column('platform', 'manufacturer_name',
                    existing_type=sa.VARCHAR(length=256),
                    nullable=False)
