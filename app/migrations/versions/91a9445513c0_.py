...
def upgrade():
    ...
    op.add_column('configuration', sa.Column('update_description', sa.String(length=256), nullable=True))
    op.add_column('device', sa.Column('update_description', sa.String(length=256), nullable=True))
    op.add_column('platform', sa.Column('update_description', sa.String(length=256), nullable=True))
