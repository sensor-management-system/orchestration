...
def upgrade():
    ...
    op.add_column('contact', sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True))
    ...
    op.create_foreign_key('fk_Contact_updated_by_id', 'contact', 'user', ['updated_by_id'], ['id'], use_alter=True)
    op.create_foreign_key('fk_Contact_created_by_id', 'contact', 'user', ['created_by_id'], ['id'], use_alter=True)
