...
def upgrade():
    ...
    op.add_column('site', sa.Column('site_usage_uri', sa.String(length=256), nullable=True))
    op.add_column('site', sa.Column('site_usage_name', sa.String(length=256), nullable=True))
