...
def upgrade():
    ...
    op.add_column('configuration', sa.Column('group_ids', sa.ARRAY(sa.Integer()), nullable=True))
    ...
    op.add_column('device', sa.Column('group_ids', sa.ARRAY(sa.Integer()), nullable=True))
    ...
    op.add_column('platform', sa.Column('group_ids', sa.ARRAY(sa.Integer()), nullable=True))
...
def downgrade():
    ...
    op.drop_column('configuration', 'group_ids')
    # ### end Alembic commands ###