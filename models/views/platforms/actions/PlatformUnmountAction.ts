...
export interface IPlatformUnmountAction {
  basicData: PlatformUnmountActionBasicData
...
export class PlatformUnmountAction implements IPlatformUnmountAction {
  private _basicData: PlatformUnmountActionBasicData
  private _configuration: ConfigurationBasicData
  private _contact: ContactBasicData

  constructor (basicData: PlatformUnmountActionBasicData,
    configuration: ConfigurationBasicData,
    contact: ContactBasicData
  ) {
  ...
  get basicData (): PlatformUnmountActionBasicData {
  ...
  static createFromObject (otherAction: IPlatformUnmountAction): PlatformUnmountAction {
    return new PlatformUnmountAction(
      PlatformUnmountActionBasicData.createFromObject(otherAction.basicData),
