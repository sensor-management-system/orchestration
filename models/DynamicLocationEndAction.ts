...
export interface IDynamicLocationEndAction {
  id: string
...
export class DynamicLocationEndAction implements IDynamicLocationEndAction {
  private _id: string = ''
  ...
  static createFromObject (someObject: IDynamicLocationEndAction): DynamicLocationEndAction {
    const result = new DynamicLocationEndAction()
