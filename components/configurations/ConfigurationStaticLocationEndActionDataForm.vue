...
export default class ConfigurationStaticLocationEndActionDataForm extends mixins(Rules) {
  private readonly labelForSelectMeButton = 'Add current user'
  @Prop({
    default: () => new StaticLocationEndAction(),
    required: true,
    type: StaticLocationEndAction
  })
  readonly value!: StaticLocationEndAction
  ...
  readonly currentUserMail!: string
