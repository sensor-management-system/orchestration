...
<template>
  <v-container fluid class="pa-0">
    <v-row no-gutters>
      <v-col>
        <v-row class="image-footer" :class="{'mb-10' : !isLandingPage, 'pb-16' : $vuetify.breakpoint.smAndDown}">
          <v-col cols="12" md="9">
          ...
          <v-col align-self="center" class="white--text body-2 footer-text" cols="12" md="3">
